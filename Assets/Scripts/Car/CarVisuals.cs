...
public class CarVisuals : MonoBehaviour
{
    ...
    public void Setup(Transform character)
    {
        this.character = character;
        if (this.character != null)
        {
            initialCharacterRot = this.character.localRotation;
        }
    }

    public void ApplyStats(float handlingStat)
    {
        turnSpeed = Mathf.Lerp(70f, 130f, handlingStat / 100f);
    }
    ...
    public void HandleVisualRotation(float moveInput, float turnInput, bool isDrifting, float driftDirection, bool isSpinning)
    {
        ...
        if(isSpinning)
        {
            ...
            character.Rotate(0, 720f * Time.deltaTime, 0);
            return;
        }
        ...
        {
            acceleration = (currentSpeed - previousSpeed) / Time.deltaTime;
        }
